...
#Remove the span
#top = soup.find(class_='c-link__icon')
#top.decompose()

#Pull the div with that class name
all_pages = soup.find(class_="default-navigation-links sidebar-navigation-links spec-sidebar-navigation-links")

# items
first_page = all_pages.find_all('li')
